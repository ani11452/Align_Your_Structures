...
def main(smiles):
    ...
    for j, rep_num in enumerate(rep_nums):
        ...
        assert md_bond_angles.shape[0] == 10*rep_num, f'The md bond angles should have shape (10*500, N), but it has shape {md_bond_angles.shape}'
    ...
    for j, rep_num in enumerate(rep_nums):
        ...
        assert md_bond_lengths.shape[0] == 10*rep_num, f'The md bond lengths should have shape (10*500, N), but it has shape {md_bond_lengths.shape}'
...
parser.add_argument('--save_name', type=str, default='mdbaseline_qm9')
